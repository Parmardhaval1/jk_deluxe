...
import 'package:latest_jk/rashi%20history.dart';
import 'package:latest_jk/rashialldraws.dart';
...
class Rashi extends StatelessWidget {
  final RashioController controller = Get.put(RashioController());
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            Get.to(() => RashiHistory(username: controller.username.value));
                          },
                          style: ElevatedButton.styleFrom(
                            backgroundColor: const Color(0xFF0E2B76),
                            foregroundColor: Colors.white,
