...
class RashiHistoryController extends GetxController {
  ...
  Future<void> _fetchHistoryData({bool isAutoRefresh = false}) async {
    try {
      ...
      final url = Uri.parse('https://demojkd.balajitechbiz.com/Application/rashi_history.php?usernm=$encodedUsername');
