...
class YantrasController extends GetxController {
  var data = <Item>[
    Item(img: 'assets/1.jpg', title: 'SHREE', date: '', time: ''),
    Item(img: 'assets/2.jpg', title: 'VASHIKARAN', date: '', time: ''),
    Item(img: 'assets/3.jpg', title: 'SUDARSHAN', date: '', time: ''),
    Item(img: 'assets/4.jpg', title: 'VASTU', date: '', time: ''),
    Item(img: 'assets/5.jpg', title: 'PLANET', date: '', time: ''),
  ].obs;

  var data2 = <Item>[
    Item(img: 'assets/6.jpg', title: 'LOVE', date: '', time: ''),
    Item(img: 'assets/7.jpg', title: 'TARA', date: '', time: ''),
    Item(img: 'assets/8.jpg', title: 'GRAH', date: '', time: ''),
    Item(img: 'assets/9.jpg', title: 'MATSVA', date: '', time: ''),
    Item(img: 'assets/10.jpg', title: 'MEDITATION', date: '', time: ''),
  ].obs;
  ...
  late Timer _timer;
  late Timer _refreshTimer; // Add this with your other variable
  ...
  void _startAutoRefreshTimer() {
    print('[${DateTime.now()}] [ yantra DEBUG for session] Starting auto-refresh timer');
    ...
    print('[${DateTime.now()}] yantra Initial session: $lastSession');

    _refreshTimer = Timer.periodic(const Duration(seconds: 10), (Timer timer) {
      final now = DateTime.now();
      final currentSession = _getCurrentSession();

      print('[${now}] [yantra DEBUG for session] Auto-refresh timer triggered');

      // Check if session has changed
      if (currentSession != lastSession) {
        print('[${now}] [yantra SESSION CHANGE] New session: $currentSession');
  ...
  void onClose() {
    ...
    _timer.cancel();
    print('[${DateTime.now()}] Closing YantrasController...');
    _timer.cancel();
