...
import 'package:latest_jk/yantra%20history.dart';
import 'package:latest_jk/yantrasalldraws.dart';
...
class Yantras extends StatelessWidget {
  final YantrasController controller = Get.put(YantrasController());
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      if (controller.shouldRefreshPage.value) {
        ...
        print('[${DateTime.now()}] Rebuilding entire Yantras page');
      }
...
=======
                    'ABC Online Trading',
>>>>>>> de711bc36e067bba64c2ba7037c9fc537150e06c
                    style: TextStyle(
                      color: Colors.amber,
            ...
            children: [
                        ...
                        Column(
                          children: [
                            Obx(
                              () => Row(
                                mainAxisAlignment: MainAxisAlignment.start,
                                children: List.generate(controller.data2.length, (
                                  index,
                                ) {
                                ...
                                ElevatedButton(
                                  onPressed:
                                      (controller
                                          ...
                                          ? null
                                          : () {
                                            if (controller.totalClicks.value >
                                                0) {
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor:
                                        controller.isLessThanThirtySeconds.value
                                            ? Colors
              ...
              Obx(
                () => SingleChildScrollView(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: List.generate(controller.last5Draws.length, (
                      index,
                    ) {
